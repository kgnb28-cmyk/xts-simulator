...
const OptionChain = ({ spotPrice = 24550, isTerminalMode, onTrade }) => {
  ...
  const s = isTerminalMode ? {
      container: "bg-black text-white font-mono text-[10px] h-full overflow-hidden flex flex-col",
      ...
      container: "bg-white text-gray-800 font-sans text-xs h-full overflow-hidden flex flex-col",
  ...
  return (
    <div className={s.container}>
        ...
        {/* FOOTER */}
        <div className={`px-2 py-1 flex justify-between ${isTerminalMode ? 'bg-black border-t border-gray-800 text-gray-500' : 'bg-gray-50 border-t border-gray-200 text-gray-400'}`}>
